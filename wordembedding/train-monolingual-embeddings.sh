...
export utils="/home/xfbai/mywork/git/MyScripts/wordembedding/utils"
...
python $utils/Predeal.py -w1 $temp/embeddings_size50.en -w2 $temp/en_wordCount.txt -o $temp/new_embedding_size50.en -o2 $temp/new_en_wordCount.txt -lang en -ft 0 -th 1000
...
python $utils/Predeal.py -w1 $temp/embeddings_size50.zh -w2 $temp/zh_wordCount.txt -o $temp/new_embedding_size50.zh -o2 $temp/new_zh_wordCount.txt -lang zh -ft 0 -th 1000
:<<!
# process en-de
